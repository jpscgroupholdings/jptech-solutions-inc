...
No accent color. Emphasis comes from inversion (black chip on white page, white text in black pill), from typography (switching to the pixel or mono font), and from texture (halftone dots). If you feel the urge to reach for blue or green, invert instead.
